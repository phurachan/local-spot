  ...
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex items-center justify-between">
          ...
          <nav class="flex items-center space-x-6">
            ...
            <NuxtLink to="/local-spot/events" class="text-green-600 font-semibold">กิจกรรม</NuxtLink>
    ...
    <section class="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">กิจกรรมท้องถิ่น</h1>
        <p class="text-xl text-purple-100">ร่วมสัมผัสประสบการณ์และกิจกรรมท้องถิ่นที่น่าสนใจ</p>
      </div>
    </section>
    ...
    <section class="py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-else-if="events.length > 0" class="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
          <NuxtLink
...
// SEO
useHead({
  title: 'กิจกรรมท้องถิ่น - Local Spot',
  meta: [
