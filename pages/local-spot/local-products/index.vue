<template>
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex items-center justify-between">
          ...
          <nav class="flex items-center space-x-6">
            ...
            <NuxtLink to="/local-spot/local-products" class="text-green-600 font-semibold">สินค้าท้องถิ่น</NuxtLink>
          </nav>
        </div>
      </div>
    </header>
    ...
    <!-- Hero Section -->
    <section class="bg-gradient-to-r from-amber-600 to-yellow-600 text-white py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">สินค้าท้องถิ่น</h1>
        <p class="text-xl text-amber-100">ผลิตภัณฑ์และของฝากคุณภาพจากท้องถิ่น</p>
      </div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="grid md:grid-cols-4 gap-4">
          ...
          >
            ...
            <option value="handicraft">หัตถกรรม</option>
            <option value="textile">ผ้าและสิ่งทอ</option>
    ...
    <section class="py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-else-if="products.length > 0" class="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
          <NuxtLink
          ...
          >
            ...
            <div class="p-4">
              <div class="flex items-center justify-between mb-2">
                <span class="badge badge-warning">{{ getCategoryLabel(product.category) }}</span>
              ...
              <div v-if="product.price" class="mb-2">
        ...
        <div v-else class="text-center py-20">
          ...
          <p class="text-gray-500 text-lg">ไม่พบสินค้าที่ตรงกับเงื่อนไขการค้นหา</p>
        </div>
        ...
        <div class="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><NuxtLink to="/local-spot/travel-services" class="text-gray-400 hover:text-white">บริการท่องเที่ยว</NuxtLink></li>
              <li><NuxtLink to="/local-spot/local-products" class="text-gray-400 hover:text-white">สินค้าท้องถิ่น</NuxtLink></li>
            </ul>
          </div>
          <div>
...
// Computed
const products = computed(() => localProductsStore.list || [])
const pagination = computed(() => localProductsStore.pagination)
...
async function loadProducts(page = 1) {
  ...
  try {
    ...
    await localProductsStore.fetchLocalProducts({ query })
  } catch (error) {
...
// SEO
useHead({
  title: 'สินค้าท้องถิ่น - Local Spot',
  meta: [
    { name: 'description', content: 'ค้นพบผลิตภัณฑ์และของฝากคุณภาพจากท้องถิ่น อาหาร หัตถกรรม สิ่งทอ' }
  ]
})
</script>
