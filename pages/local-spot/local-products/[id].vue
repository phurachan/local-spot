  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-else-if="product" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav class="flex mb-6 text-sm">
        <NuxtLink to="/local-spot" class="text-gray-500 hover:text-gray-700">หน้าแรก</NuxtLink>
        <span class="mx-2 text-gray-400">/</span>
        <NuxtLink to="/local-spot/local-products" class="text-gray-500 hover:text-gray-700">สินค้าท้องถิ่น</NuxtLink>
        <span class="mx-2 text-gray-400">/</span>
...
// SEO
useHead({
  title: computed(() => product.value ? `${product.value.title} - Local Spot` : 'สินค้าท้องถิ่น - Local Spot'),
  meta: computed(() => [
