  ...
  <div class="min-h-screen">
      ...
      <div class="relative z-10 h-full flex items-center justify-center text-center">
        <div class="max-w-4xl px-6">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#hotels" class="bg-green-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-green-400 transition-colors">
              เริ่มค้นหา
            </a>
      ...
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div v-else class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <NuxtLink
            ...
            :key="hotel._id"
            :to="`/local-spot/hotels/${hotel._id}`"
            class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group"
          >
            <div class="h-48 bg-gray-200 overflow-hidden">
              <img
        ...
        <div class="text-center mt-12">
          <NuxtLink to="/local-spot/hotels" class="btn btn-primary btn-lg">
            ดูโรงแรมทั้งหมด
          </NuxtLink>
        </div>
      </div>
      ...
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div v-else class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <NuxtLink
            ...
            :key="restaurant._id"
            :to="`/local-spot/restaurants/${restaurant._id}`"
            class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group"
          >
            <div class="h-48 bg-gray-200 overflow-hidden">
              <img
        ...
        <div class="text-center mt-12">
          <NuxtLink to="/local-spot/restaurants" class="btn btn-secondary btn-lg">
            ดูร้านอาหารทั้งหมด
          </NuxtLink>
        </div>
      </div>
      ...
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div v-else class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <NuxtLink
            ...
            :key="event._id"
            :to="`/local-spot/events/${event._id}`"
        ...
        <div class="text-center mt-12">
          <NuxtLink to="/local-spot/events" class="btn btn-primary btn-lg">
            ดูกิจกรรมทั้งหมด
          </NuxtLink>
        </div>
      </div>
      ...
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div v-else-if="featuredTravelServices.length > 0" class="grid md:grid-cols-3 gap-8">
          <NuxtLink
            ...
            :key="service._id"
            :to="`/local-spot/travel-services/${service._id}`"
        ...
        <div class="text-center mt-12">
          <NuxtLink to="/local-spot/travel-services" class="btn btn-primary btn-lg">
      ...
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div v-else-if="featuredLocalProducts.length > 0" class="grid md:grid-cols-3 gap-8">
          <NuxtLink
            ...
            :key="product._id"
            :to="`/local-spot/local-products/${product._id}`"
            class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow cursor-pointer"
          >
        ...
        <div class="text-center mt-12">
          <NuxtLink to="/local-spot/local-products" class="btn btn-primary btn-lg">
            ดูผลิตภัณฑ์ทั้งหมด
          </NuxtLink>
        </div>
      </div>
    ...
    <section class="py-20 bg-gradient-to-r from-green-600 to-teal-600 text-white">
      <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <NuxtLink to="/local-spot/hotels" class="bg-white text-green-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-green-50 transition-colors">
            เริ่มค้นหา
          </NuxtLink>
        </div>
      </div>
      ...
      <div class="max-w-6xl mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-400">
              <li><a href="#about" class="hover:text-white transition-colors">เกี่ยวกับ Local Spot</a></li>
              <li><a href="#contact" class="hover:text-white transition-colors">ติดต่อเรา</a></li>
              <li><NuxtLink to="/local-spot/login" class="hover:text-white transition-colors">เข้าสู่ระบบ</NuxtLink></li>
            </ul>
          </div>
          <div>
            ...
            <div class="flex space-x-4">
              ...
              <!-- Line -->
              <a href="#" class="text-gray-400 hover:text-white transition-colors" aria-label="Line">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
