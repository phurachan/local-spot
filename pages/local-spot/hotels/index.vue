  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <section class="bg-gradient-to-r from-green-600 to-teal-600 text-white py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">โรงแรมและที่พัก</h1>
        <p class="text-xl text-green-100">ค้นพบที่พักสะดวกสบาย บรรยากาศดี ในท้องถิ่น</p>
      </div>
    </section>
    ...
    <section class="py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-else-if="hotels.length > 0" class="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
          <NuxtLink
