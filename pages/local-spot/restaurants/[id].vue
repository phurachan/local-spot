<template>
  <div class="min-h-screen bg-gray-50">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div class="flex items-center">
              ...
              <NuxtLink to="/local-spot/restaurants" class="ml-1 text-gray-700 hover:text-green-600">ร้านอาหาร</NuxtLink>
            </div>
          </li>
    ...
    <div v-else class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
      ...
      <NuxtLink to="/local-spot/restaurants" class="btn btn-primary">
...
// SEO
useHead(() => ({
  title: restaurant.value ? `${restaurant.value.title} - Local Spot` : 'ร้านอาหาร - Local Spot',
  meta: [
