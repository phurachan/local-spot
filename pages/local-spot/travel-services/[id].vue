  ...
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex items-center justify-between">
          ...
          <nav class="flex items-center space-x-6">
            ...
            <NuxtLink to="/local-spot/travel-services" class="text-green-600 font-semibold">บริการท่องเที่ยว</NuxtLink>
    ...
    <div v-else-if="service" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav class="flex mb-6 text-sm">
        ...
        <NuxtLink to="/local-spot/travel-services" class="text-gray-500 hover:text-gray-700">บริการท่องเที่ยว</NuxtLink>
        <span class="mx-2 text-gray-400">/</span>
