import { TravelServiceContent } from '~/server/models/CMS'
...
export default defineEventHandler(async (event) => {
  try {
    ...
    // Delete travel service
    await TravelServiceContent.findByIdAndDelete(id)

    return createSuccessResponse(
      { id, message: 'Travel service deleted successfully' },
